...
void handleRoot() {
  ...
  String html = String("<html>\n")
              ...
              + String("          <tr>\n")
              + String("            <td colspan='2' align='center'><font face='Arial'>Current Count: <font color='blue'><b>") + data.count + String("</b></font></font></td>\n")
              + String("          </tr>\n")
              + String("          <tr>\n")
              + String("            <td colspan='2' align='center'><font face='Arial'>Single Step: <input name='step' id='step' value='") + data.stepp + String("'></font></td>\n")
              + String("          </tr>\n")
              + String("          <tr>\n")
              ...
              + String("          <tr>\n")
              + String("            <td align='center'><button onclick='return submitCommand(1)'>Factory Reset</button></td>\n")
              + String("            <td align='center'><button onclick='return submitCommand(2)'>Restart</button></td>\n")
              + String("          </tr>\n")
              + String("        </table>\n")
              + String("      </form>\n")
              + String("    </center>\n")
